...
//#define ENABLE_PIN  B00010000
//#define SHIFT_RW B10000000
//#define RS_PIN      B00100000
...
void LCD3Wire::writeIn(char msg[]) {
  unsigned int i;
...
void LCD3Wire::_pushByte(uint8_t value, bool command) {
  int nibble = 0;
...
void LCD3Wire::_pushNibble(uint8_t nibble, bool command) {
  if (!command) {
...
void LCD3Wire::_pushOut(uint8_t value) {
...
void LCD3Wire::cursorTo(uint8_t line_num, uint8_t x){
...
void LCD3Wire::leftScroll(uint8_t num_chars, uint8_t delay_time){
